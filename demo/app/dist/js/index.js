/*! Gaodun modified this file at 2017-6-2 14:17:23 */
webpackJsonp([0],[
/* 0 */
...
Component.options.__file = "D:\\github\\frame\\demo\\app\\src\\js\\components\\App.vue"
...
var _BaseFetch = __webpack_require__(57);
...
exports.__esModule = true;
var deriveStateNumber = exports.deriveStateNumber = function deriveStateNumber(state) {
...
var getters = {
    checkoutNumber: function checkoutNumber(state) {
        return state.number + 3;
    }
};
// 方法调用逻辑
var actions = {
    actionsAdd: function actionsAdd(_ref, p) {
        var commit = _ref.commit,
            state = _ref.state,
            dispatch = _ref.dispatch;

        commit(_mutationTypes.ADD, "your parameters");
    },
    actionsSubtract: function actionsSubtract(_ref2, p) {
...
// 逻辑代码
var mutations = (_mutations = {}, _mutations[_mutationTypes.ADD] = function (state, a) {
    state.number += 1;
}, _mutations);
exports['default'] = {
    state: state,
...
Component.options.__file = "D:\\github\\frame\\demo\\app\\src\\js\\components\\List.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("加")]), _vm._v(" "), _c('button', [_vm._v("减")])]), _vm._v("\n    ------------------------------\n    "), _c('list')], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
...
var update = __webpack_require__(117)("148090f6", content, false);

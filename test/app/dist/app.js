/*! Gaodun modified this file at 2017-5-22 17:00:14 */
webpackJsonp([0],[
/* 0 */
...
var store = new _vuex2['default'].Store({
    ...
    mutations: {
        ...
        updateMessage: function updateMessage(state, value) {
            _vue2['default'].set(state, 'message', value);
        }
    },
    actions: {
        ...
        updateMessage: function updateMessage(_ref2, e) {
...
var Counter = {
    ...
    computed: (0, _extends3['default'])({}, (0, _vuex.mapState)({
        ...
        countAlias: 'abc'
    }), (0, _vuex.mapGetters)(['doneTodos', 'test'])),
    methods: (0, _extends3['default'])({}, (0, _vuex.mapMutations)({
        add: 'increment'
    }), (0, _vuex.mapActions)(['updateMessage']))

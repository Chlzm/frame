/*! liu modified this file at 2017-5-28 23:33:02 */
webpackJsonp([0],[
/* 0 */
...
var _detail = __webpack_require__(68);
...
var _Detail = __webpack_require__(122);
...
// module
exports.push([module.i, "\nul,ol{list-style:none;\n}\n", "", {"version":3,"sources":["/./demo/app/src/js/components/App.vue?b5519b88"],"names":[],"mappings":";AAeA,MAAA,gBAAA;CAAA","file":"App.vue","sourcesContent":["<template>\r\n    <div id=\"app\">\r\n        <h1>首页</h1>\r\n        <ul>\r\n            <li><router-link to=\"/\">/</router-link></li>\r\n            <li><router-link to=\"/parent\">/parent</router-link></li>\r\n            <li><router-link to=\"/parent/foo\">/parent/foo</router-link></li>\r\n            <li><router-link to=\"/parent/bar\">/parent/bar</router-link></li>\r\n        </ul>\r\n        <transition name=\"fade\" mode=\"out-in\">\r\n            <router-view class=\"view\"></router-view>\r\n        </transition>\r\n    </div>\r\n</template>\r\n<style>\r\n    ul,ol{list-style:none;}\r\n</style>\r\n<script>\r\n    import List from './List.vue';\r\n    import Detail from './Detail.vue';\r\n    import store from '../store';\r\n    import { mapState,mapGetters,mapMutations,mapActions} from 'vuex';\r\n    export default {\r\n        props:['inputValue'],\r\n        components: {List,Detail},\r\n        methods:{\r\n            triggerAdd(){\r\n                this.$store.dispatch('triggerAddToCart')\r\n            }\r\n        },\r\n        computed: {\r\n            ...mapState({\r\n                count:state=>{\r\n                    return state.list.message;\r\n                }\r\n            }),\r\n            ...mapGetters([\r\n                'changeMessage'\r\n            ])\r\n           /* count(){\r\n                console.log(this)\r\n                return store.state.list.message\r\n            }*/\r\n        }\r\n    }\r\n</script>\r\n"],"sourceRoot":"webpack://"}]);
...
var update = __webpack_require__(130)("8fefd328", content, false);

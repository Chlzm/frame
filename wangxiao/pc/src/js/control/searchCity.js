...
import {ctiyJson} from './airCityFormat';
        ...
        name.click(function (e) {
            ...
            function ajaxadd(data) {
                ...
                $('.cityPanel .city_body li').click(function (e) {
                    ...
                    if($thisname=='AirEndCity1'){
                        $('.select_city1').val($thisval).attr("data-id",$thisSzm);
                    }
                });
                //将最小高度删除 改为自适应
    ...
    $('.changePosition1').click(function () {
        ...
        $('.select_city1').val($('.leaveCity1').val());
    });
    //迪士尼插件 起飞城市
    ;(function(){
        var airCity = {
            ...
            horn:function () {
                var cityFun,    //data数据拼接
                    ...
                    livalfun1;
                //全部城市模块
                var ctiyall='<div class="cityfrom1 hideBox" style="display: none">'+
    ...
    ;(function () {
        ...
        SearchTip.prototype.bindInput = function () {
            ...
            $("input[type=text]", this.result).on("input", function () {
                ...
                if (that.attr("data-type") == "hotel" || that.attr('name') == 'AirEndCity1') {
        ...
        SearchTip.prototype.bindBlur = function () {
            ...
            $("input[name=gw_city1]", this.result).on("blur", function (e) {
                if(!$(this).attr("data-id")){
                    $(this).val("");
                }
            })
        ...
        SearchTip.prototype.keyDown = function (e) {
            ...
            $("input[type=text]", this.result).off("keyup").on("keyup", function (e) {
                //回车出发验证
                $(this).blur(function () {
                    if($(this)[0].name=='AirEndCity1'){
                        $('.select_city1').val($(this).val());
                    }
                });
                switch (e.keyCode) {
                    case 38://up
